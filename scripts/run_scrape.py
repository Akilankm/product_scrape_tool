...
async def main() -> None:
    ...
    print(f"capture_profile_used: {result.capture_profile_used}")
    print(f"capture_profiles_attempted: {result.capture_profiles_attempted}")
    print(f"capture_score: {result.capture_score}")
    print(f"capture_grade: {result.capture_grade}")
    print(f"real_scrape_evidence: {result.real_scrape_evidence}")
    print(f"weak_capture_reasons: {result.weak_capture_reasons}")
